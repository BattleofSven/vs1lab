...
class InMemoryGeoTagStore {
    ...
    // TODO: ... your code here ...
    getTagByUUID(uuid) {
        return this.#geoTags.find(geoTag => geoTag.uuid === uuid);
    }

    updateTagByUUID(uuid, latitude, longitude, name, hashtag) {
        const tag = this.getTagByUUID(uuid);
    ...
    deleteTagByUUID(uuid) {
        this.#geoTags = this.#geoTags.filter(geoTag => geoTag.uuid !== uuid);
    }
}
